 ...
 */
class CRM_Card_Upgrader_Base {

  /**
   * @var CRM_Card_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Card_Upgrader(
        'com.skvare.card',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Card_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Card_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
